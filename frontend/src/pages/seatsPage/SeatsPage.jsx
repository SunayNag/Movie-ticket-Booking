  ...
  for (let i = 1; i < theatreDetails?.balconySeats + 1; i++) {
    balconyLiTags.push(
      <li
        ...
        style={{
          backgroundColor: selectedSeats?.balcony.includes(i) && "#006666",
        }}
  ...
  for (let i = 1; i < theatreDetails?.middleSeats + 1; i++) {
    middleLiTags.push(
      <li
        ...
        style={{
          backgroundColor: selectedSeats?.middle.includes(i) && "#006666",
        }}
  ...
  for (let i = 1; i < theatreDetails?.lowerSeats + 1; i++) {
    lowerLiTags.push(
      <li
        ...
        style={{
          backgroundColor: selectedSeats?.lower.includes(i) && "#006666",
        }}
